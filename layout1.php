      ...
      <ol class="seats" type="A">
        ...
        <li class="seat">
          <?php
            ...
            $slot = $_SESSION['timeslot']
            mysqli_select_db( $conn, $mysqldb);

          $query = "SELECT * FROM `seat_layout` WHERE `name`= '$mname' and `seat_name`='1D' and `Timeslot` = '$slot'";
        ...
        <li class="seat">
          ...
          $mname = $_SESSION['movie_name'];
            ...
            $query = "SELECT * FROM `seat_layout` WHERE `name`= '$mname' and `seat_name`='1E' and `Timeslot` = '$slot'";
          $result = mysqli_query($conn,$query);
          $row = mysqli_fetch_assoc($result);
          //echo mysqli_num_rows($result);
          $display = $row[seat_status];
